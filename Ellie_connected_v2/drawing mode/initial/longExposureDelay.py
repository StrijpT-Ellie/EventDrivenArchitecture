#This script adds long exposure effect 
#It uses the camera feed to create a pixelated image
#The movement is returned with delay 
#As well it becomes mostly white if it is light enough and the body area pecomes visible 
...
while True:
    ...
    long_exposure_frame = cv2.addWeighted(long_exposure_frame, 0.95, enlarged_pixelated.astype(np.float32), 0.1, 0)
