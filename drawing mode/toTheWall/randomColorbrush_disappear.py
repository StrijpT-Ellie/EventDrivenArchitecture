...
while True:
    ...
    # Apply fading effect to persistent pixels
    fade_factor = 0.92  # Adjust fade factor to control fading speed
    persistent_pixels = cv2.addWeighted(persistent_pixels, fade_factor, np.zeros_like(persistent_pixels), 1 - fade_factor, 0)
