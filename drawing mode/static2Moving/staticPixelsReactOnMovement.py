#this script craetes a 20 by 20 grid of pixels that react to movement detected by the camera
#the pixels will float around if movement is detected
...
while True:
    ...
    transition_buffer = cv2.addWeighted(transition_buffer, 0.9, pixelated.astype(np.float32), 0.1, 0)
