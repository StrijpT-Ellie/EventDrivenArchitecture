#Video is projected on pixelated grid, with each pixel being a circle
#The circles flicker when the camera detects motion
#Body area becomes black, while the rest of the image becomes white with some colors
